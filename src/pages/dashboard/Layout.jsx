...
const navigation = [
  ...
  { name: 'Branches', href: '/dashboard/branches', icon: Bars3CenterLeftIcon, current: false },
  { name: 'ProfileUpdate', href: '/dashboard/update-profile', icon: PencilSquareIcon, current: false },
...
export default function DashboardLayout() {
  ...
  const userNavigation = [
    { name: 'Your Profile', action: () => navigate('/dashboard/profile') },
